<!-- autogenerated using git::gitlab.com/konradodwrot/cross-repo/prose/assets@v0.0.69//repos/ai-harness/ai-tools-configs/templates/3-audience/README.md.ontoRepo.tpl -->
# configs
